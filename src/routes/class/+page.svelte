<script>
  import { Amazon, Yahoo, Zoom, Youtube } from '$lib';
  import NewBrave from '$lib/NewBrave.svelte';
  import NewGandi from '$lib/NewGandi.svelte';
</script>

<NewGandi />

<svg xmlns="http://www.w3.org/2000/svg" aria-label="Brave" role="img" viewBox="0 0 512 512"
  ><rect width="512" height="512" fill="#fff" /><linearGradient id="a"
...
>
<Amazon size="100" />
<Amazon class="m-4" size="100" />
<Yahoo style="padding:10px;" size="100" />
<Zoom size="100" />
<Youtube size="100" />
