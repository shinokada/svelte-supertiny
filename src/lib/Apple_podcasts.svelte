...
<svg
  ...
  on:mouseout
  viewBox="0 0 512 512"
  ><path d="m0 0H512V512H0" fill="url(#apple_podcasts)" /><linearGradient
    id="apple_podcasts"
    x2="0"
    y2="1"
