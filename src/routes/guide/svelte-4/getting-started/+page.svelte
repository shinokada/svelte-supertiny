<script lang="ts">
  ...
  const npmVersion: NpmVersionPropsType = {
    ...
    link: [
      ...
      'https://github.com/shinokada/svelte-supertiny'
    ]
  };
  ...
  const license: LicensePropsType = {
    ...
    github_repo: 'svelte-supertiny',
    link: [
      'https://github.com/shinokada/svelte-supertiny/blob/master/LICENSE',
      'https://github.com/shinokada/svelte-supertiny/blob/master/LICENSE'
    ]
  };
...
<h1>Getting Started - Svelte Supertiny v1</h1>
