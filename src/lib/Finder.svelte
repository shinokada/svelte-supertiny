...
<svg
  ...
  on:mouseout
  viewBox="0 0 512 512"
  ><rect width="512" height="512" fill="url(#finder)" /><defs
    ><linearGradient id="finder" x2="0" y1="100%"
  ...
  ><path
    fill="url(#b)"
    d="M512 0H274.4c-21.2 49.2-59.2 129.6-60.8 283.4a9.9 9.9 0 0010 10.1h58.7a9.9 9.9 0 019.9 10.2A933.3 933.3 0 00311.3 512h256 0z"
  /><path
    fill="none"
    stroke="#000"
