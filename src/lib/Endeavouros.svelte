...
<svg
  ...
  /><path
    ...
    fill="#ff7f7f"
  /><path
    d="M285 111.36C278.5 110.28 129.6 358.7 129.6 358.7s135.06 14.55 190.71 13.58c156.78-2.7 1.2-212-35-261.18a.3.3 0 0 0-.17-.1z"
    fill="#7f3fbf"
  /></svg
>
...
@props:ariaLabel?:  string; = 'Endeavouros';
@props:class?: string;
