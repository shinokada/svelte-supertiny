...
<svg
  ...
  on:mouseout
  viewBox="0 0 512 512"
  ><path d="m0 0H512V512H0" fill="#fff" /><radialGradient id="safari"
  ...
  ><g transform="matrix(4 0 0 4 256 256)"
    ...
    ><path d="M6 6l-12-12l-29 39" fill="#eee" /><path d="M6 6l-12-12l41-28" fill="#f55" /><path
      opacity=".3"
      d="M-35 33l7-5-3 5 37-27 28-35-4 2 4-6"
    /></g
  ></svg
>
